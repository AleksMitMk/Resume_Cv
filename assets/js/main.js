$(function(){
    ...
    let hoveredText = [{bill_01: 'Make sure that your title matches your skills. E.g., if you’re an entry level PHP developer, don’t say that you’re a PHP Expert. Skip the abbreviations and titles – keep it short and modest.',
...
$(document).on('dblclick', '.info', function(e){
...
$(document).on('mouseout','.allHovers',function(){
  ...
  //Input Achievements/Tasks to fill the ul lists
    ...
    $(document).on('keyup', '#tasksInp', function(e){
        ...
        if(e.keyCode === 13){
            console.log('ace');
                $(`.`+`${inpClass}`+`Ul`).append(`<li class="ulLi" ><h5 contenteditable="true">${tasksInp}</h5><span class="delUlLi"><i class="far fa-trash-alt"></i></span></li>`)
                $(`.`+`${inpClass}`).val('');
            }
    })
